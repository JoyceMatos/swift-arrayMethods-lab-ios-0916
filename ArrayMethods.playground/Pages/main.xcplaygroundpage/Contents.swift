...
if emptyArray.isEmpty {
    print("Whoops, looks like there's nothing there!")
} else {
    print("Wow! We are full!") }
...
if !reverseEmptyArray.isEmpty {
    print("Look at what we have here.")
} else {
 ...
 */
var numOfDays = daysOfTheWeek.count

for number in daysOfTheWeek.enumerate() {
